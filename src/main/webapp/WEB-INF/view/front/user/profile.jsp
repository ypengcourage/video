...
<body class="w100">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath }/front/user/profile.do" method="post">
                                ...
                                <div class="form_submit dd">
                                    ...
                                    <a href="${pageContext.request.contextPath }/front/user/profile.do?id=${user.id}">重置</a>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath }/static/js/jquery.cityselect.min.js"></script>
