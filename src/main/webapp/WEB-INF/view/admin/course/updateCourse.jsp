	    ...
	    <div class="container theme-showcase" role="main">
		    ...
		    <form class="form-horizontal" action="${pageContext.request.contextPath }/admin/course/updateCourse.action" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="标题" name="courseName" value="${course.courseName }">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">简介</label>
			    <div class="col-sm-10">
			      <textarea class="form-control" id="inputPassword3" name="courseDescr" >${course.courseDescr }</textarea>
			    </div>
			  </div>
			  <div class="form-group">
